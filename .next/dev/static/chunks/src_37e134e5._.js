...
const getRGBA = (cssColor, fallback = "rgba(180, 180, 180)")=>{
    ...
    try {
        ...
        if (typeof cssColor === "string" && cssColor.startsWith("var(")) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$bits$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRGBA"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$bits$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"](computedColor));
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$bits$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRGBA"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$bits$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"](cssColor));
    } catch (e) {
...
const colorWithOpacity = (color, opacity)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$bits$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRGBA"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$bits$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alpha"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$bits$2f$build$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"](color), opacity));
};
const focusInput = [
    // base
    "focus:ring-2",
...
"[project]/src/lib/config.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Highlight = ({ children, className })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-1 py-0.5 font-medium dark:font-semibold text-secondary", className),
        children: children
    }, void 0, false, {
...
"[project]/src/components/nav-menu.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const navs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteConfig"].nav.links;
function NavMenu() {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavMenu.useEffect": ()=>{
            const updateIndicator = {
                "NavMenu.useEffect.updateIndicator": ()=>{
            ...
            return ({
                "NavMenu.useEffect": ()=>clearTimeout(timer)
            })["NavMenu.useEffect"];
        }
    }["NavMenu.useEffect"], [
        pathname
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavMenu.useEffect": ()=>{
            const initializeIndicator = {
                "NavMenu.useEffect.initializeIndicator": ()=>{
                    const activeNavItem = ref.current?.querySelector(`[data-href="${pathname}"]`)?.parentElement;
                    if (activeNavItem) {
                        const rect = activeNavItem.getBoundingClientRect();
                        setLeft(activeNavItem.offsetLeft);
...
_s(NavMenu, "s9yRTLzkkyZBKPZYsQXEC/DMdt0=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$nav$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/nav-menu.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/config.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
...
function Navbar() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Navbar.useEffect": ()=>{
            const unsubscribe = scrollY.on("change", {
                "Navbar.useEffect.unsubscribe": (latest)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("sticky z-50 mx-4 flex justify-center transition-all duration-300 md:mx-0", hasScrolled ? "top-6" : "top-4 mx-0"),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("mx-auto max-w-7xl rounded-2xl transition-all duration-300  xl:px-0", hasScrolled ? "px-2 border border-[#34D399] backdrop-blur-lg bg-background/75" : "shadow-none px-7"),
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$nav$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NavMenu"], {}, void 0, false, {
                                fileName: "[project]/src/components/sections/navbar.tsx",
                                lineNumber: 114,
                                columnNumber: 13
                            }, this),
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].ul, {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                                            children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteConfig"].nav.links.map((item)=>{
                                                const isActive = isLinkActive(item.href);
...
_s(Navbar, "RtIvdsBgqeJXO3pRBAr5JBSa/wk=", false, function() {
    return [
...
//# sourceMappingURL=src_37e134e5._.js.map